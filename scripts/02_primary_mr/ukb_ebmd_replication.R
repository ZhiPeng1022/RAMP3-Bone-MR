# UKB 足跟 eBMD 复制：
# ebi-a-GCST90029004 (Loh 2018), ukb-b-8875 (Elsworth 2018),
# ebi-a-GCST90014022 (Mbatchou 2021)
...
out <- extract_outcome_data(
  snps = snps,
  outcomes = c("ebi-a-GCST90029004", "ukb-b-8875", "ebi-a-GCST90014022")
)
cat("UKB eBMD 复制匹配行数：", nrow(out), "\n")
write.csv(out, file.path(DATA, "ukb_ebmd_replication_outcomes.csv"), row.names = FALSE)
...
for (oid in c("ebi-a-GCST90029004", "ukb-b-8875", "ebi-a-GCST90014022")) {
...
writeLines(out_md, "results/summary/ukb_ebmd_replication_results.md")
